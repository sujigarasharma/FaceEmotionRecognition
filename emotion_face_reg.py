...
bavan_image = face_recognition.load_image_file("bavan.jpg")
bavan_face_encoding = face_recognition.face_encodings(bavan_image)[0]
...
third_image = face_recognition.load_image_file("third.jpg")
